...
var DomTestingLibrary__Queries = require("../src/DomTestingLibrary__Queries/DomTestingLibrary__Queries.js");
...
Jest.test("getByLabel", (function (param) {
        return Jest.Expect.toMatchSnapshot(Jest.Expect.expect(DomTestingLibrary__Queries.getByLabelText(render("<label for=\"title\">Title</label><input type=\"text\" id=\"title\" />"), {
                            NAME: "Str",
                            VAL: "Title"
                          })));
      }));
...
Jest.test("getByText", (function (param) {
        return Jest.Expect.toMatchSnapshot(Jest.Expect.expect(DomTestingLibrary__Queries.getByText(render("<span>Hello world</span>"), {
                            NAME: "Str",
                            VAL: "Hello world"
                          })));
      }));
...
Jest.test("getByRole", (function (param) {
        return Jest.Expect.toMatchSnapshot(Jest.Expect.expect(DomTestingLibrary__Queries.getByRole(render("<option role=\"option\">Option</option>"), {
                            NAME: "Str",
                            VAL: "option"
                          })));
      }));
...
Jest.test("getByPlaceholderText", (function (param) {
        return Jest.Expect.toMatchSnapshot(Jest.Expect.expect(DomTestingLibrary__Queries.getByPlaceholderText(render("<input type=\"text\" placeholder=\"title\" />"), {
                            NAME: "Str",
                            VAL: "title"
                          })));
      }));
...
Jest.test("getByDisplayValue", (function (param) {
        return Jest.Expect.toMatchSnapshot(Jest.Expect.expect(DomTestingLibrary__Queries.getByDisplayValue(render("<input type=\"text\" placeholder=\"title\" value=\"Red\" />"), {
                            NAME: "Str",
                            VAL: "Red"
                          })));
      }));
...
Jest.test("getByAltText", (function (param) {
        return Jest.Expect.toMatchSnapshot(Jest.Expect.expect(DomTestingLibrary__Queries.getByAltText(render("<img alt=\"alt text example\" />"), {
                            NAME: "Str",
...
Jest.test("getByTitle", (function (param) {
        return Jest.Expect.toMatchSnapshot(Jest.Expect.expect(DomTestingLibrary__Queries.getByTitle(render("<span title=\"title example\" />"), {
                            NAME: "Str",
                            VAL: "title example"
                          })));
      }));
...
Jest.test("getByTestId", (function (param) {
        return Jest.Expect.toMatchSnapshot(Jest.Expect.expect(DomTestingLibrary__Queries.getByTestId(render("<div data-testid=\"test-id\">Test ID</div>"), {
                            NAME: "Str",
                            VAL: "test-id"
                          })));
      }));
